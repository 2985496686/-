...
- 读操作：先查询缓存获取理想消息id()，然后同msg_to确定要查询的表，mg_id确定要查询的消息。


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwNTY3MTE0OSwtNzI5NjIyMzIxLC05Mz
YwNjYyMDAsMzYwMzI2NDU4LDExMTQ2NjA0MTcsODA1MjcxNDc5
LDEyMjk4NjYwMDAsLTQ2OTY2MDQ3MCw3NzcxMTgwOTgsMzY1OT
