...
ipConfig的服务发现借助了 ``etcd 的watch机制`` ，以满足服务发现的极时性需求。当ipConfig服务启动后会开启一个服务发现的协程，该协程首先会调用etcd client的get方法，发现已有的服务。然后将发现的服务数据封装成添加服务事件，通知serviceManage




<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM0ODM0ODk1MCw3NzM1NTIyNjUsLTIxMz
UwMTg4NjRdfQ==
-->