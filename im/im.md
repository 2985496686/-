...
ipConfig的服务发现借助了 ``etcd 的watch机制`` ，以满足服务发现的极时性需求。当ipConfig服务启动后会开启一个服务发现的协程，该协程首先会初始化服务，调用etcd client的get方法，发现已有的服务。然后将发现的服务数据封装成添加服务事件，通知serviceManage。初始化完毕后，协程通过watch机制监听etcd服务的变更，同时将变更的数据封装成




<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU1MzY5MTg4LDc3MzU1MjI2NSwtMjEzNT
AxODg2NF19
-->