...
```shell
docker run -d --name redis-node-1 --net host --privileged=true -v  /home/gtl/docker_data
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTQxODE5NDIsMTMxMjkxODU2Niw0Nz
...
E3ODQyLC04NDIyNDk5MTgsNDE3ODQyLC02NTAwNTM1MDddfQ==
