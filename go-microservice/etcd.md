...
虽然etcd提供了微事务，当它并不算是真正事务，通过原子性的compare-and-swap（CAS）操作，可以在一个事务中执行多个读写操作。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM0OTczODEzMCwtMjEzNTUxNDE1OSwtND
...
NzQsNDIzNTc1Nzg1LC0xOTIzMzAxMjAsLTQ5MjA2Njk1NSwxMT
