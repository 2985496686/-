...
基于etcd实现的分布式锁基本上使用到了etcd的全部性质，并且保证了分布式锁的互斥性，安全性和可用性。官方实现的分布式锁并不支持可重入性，但是要实现可重入

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNzI3MzE5Myw3NTgwNjg0OTAsMTE2ND
A1NDM0OSwtMTI0NDY3MzI3NCw0MjM1NzU3ODUsLTE5MjMzMDEy
MCwtNDkyMDY2OTU1LDExNTc3OTM5NDksLTEyODYwNTExODAsMj
