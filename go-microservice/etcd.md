...
有这样一个场景：三个节点的raft集群，其中一个follower节点与其他两个节点出现了网络分区，这个follower因为竞选超时，由follower转变为了candidate，任期加1，但是他的这个网络分区
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0MjIyNTgxNSwyMDcwNzU4OTM2LC0xMz
